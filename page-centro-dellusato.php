...
$branch_name = 'Mogliano Veneto (TV)';
...
<main class="page-wrapper">
			...
			<div class="col-12 col-xxl-10">
				<div class="row">
					...
					<div class="col-12 col-lg-7 offset-xl-1 mt-4 mt-lg-0">
						<img src="<?= get_template_directory_uri(); ?>/assets/images/contatti/automarca-mogliano-int.jpg" class="img-fluid" alt="">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="container-fluid section">
		<div class="row justify-content-center">
			<div class="col-12 map-container" id="map" data-branch-office-data='{"name":"Automarca Plus","branch":"Mogliano Veneto","address":"Via Marconi, 50<br>31021, Mogliano Veneto (TV)","contact":"info@automarca.it<br>+39 041 8622421","link":"https://goo.gl/maps/44pHBs81be7FpNju8","center":{"lat":45.569529238786025,"lng":12.235443779711224}}'>
