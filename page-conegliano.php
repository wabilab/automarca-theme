...
<main class="page-wrapper">
			...
			<div class="col-12 col-xxl-10">
				<div class="row">
					...
					<div class="col-12 col-lg-7 offset-xl-1 mt-4 mt-lg-0">
						<img src="<?= get_template_directory_uri(); ?>/assets/images/contatti/automarca-conegliano-int.jpg" class="img-fluid" alt="">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="container-fluid section">
		<div class="row justify-content-center">
			<div class="col-12 map-container" id="map" data-branch-office-data='{"name":"Automarca Spa","branch":"Conegliano","address":"Via Bradolini, 2/4<br>31020, San Fior (TV)","contact":"info@automarca.it<br>+39 0438 400446","link":"https://goo.gl/maps/vmZUuHcAEmv38pw29","center":{"lat":45.90303920654703,"lng":12.3362138713932}}'>
